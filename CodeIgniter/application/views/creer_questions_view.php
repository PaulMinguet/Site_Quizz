    ...
    <div class='quizz' style='height: 575px;'>
        ...
        <div class='each_quest'>
            ...
            <div class='line reponse'>
                ...
                <input type='text' name='choix1' id='area_choix' class='area_qz' placeholder='Entrez la possibilité 1' onclick='colorizeNB5()' required/>
                <input type='text' name='choix2' id='area_choix' class='area_qz' style='margin-top:8%;' placeholder='Entrez la possibilité 2' onclick='colorizeNB5()' required/>
                <input type='text' name='choix3' id='area_choix' class='area_qz' style='margin-top:16%;' placeholder='Entrez la possibilité 3' onclick='colorizeNB5()' required/>
                <input type='text' name='choix4' id='area_choix' class='area_qz' style='margin-top:24%;' placeholder='Entrez la possibilité 4' onclick='colorizeNB5()' required/>
